...
# Define las aplicaciones de Django
DJANGO_APPS = [
...
# Define tus aplicaciones personalizadas
PROJECT_APPS = ['apps.user']

# Define aplicaciones de comercio electrónico
ECOMMERCE_APPS = []

# Define aplicaciones de terceros
THIRD_PARTY_APPS = [
    'corsheaders',
    'rest_framework',
    'djoser',
...
# Combina todas las listas en INSTALLED_APPS
